            ...
            <Dialog className=" relative right-[1em] w-[25em]  md:right-0 md:w-0 lg:right-0 lg:w-0" open={open} handler={handleOpen} style={{ background: mode === 'light' ? '#2f3542' : '#2f3542', color: mode === 'dark' ? 'white' : 'black' }}>
                ...
                <DialogBody >
                    <div className="flex justify-center flex-wrap  sm:mx-auto sm:mb-2 -mx-2  mt-4 mb-2 ">
                        ...
                        <div className="">
                            <div className="flex gap-3">
                                {/* Linkedin Icon  */}
                                <div className="">
                                    <a href="https://www.linkedin.com/in/nittish-baboria-73b416298/">
                                ...
                                {/* Instagram Icon  */}
                                <div className="">
                                    <a href="https://www.instagram.com/nittish_baboria/">
                                ...
                                {/* Github Icon  */}
                                <div className="">
                                    <a href="https://github.com/nittish03">
                    ...
                    <div className=" text-center">
                        <h1 className=" text-gray-600">Powered By Nittish</h1>
                    </div>
                </DialogBody>
            </Dialog>
        </Fragment>
