        ...
        <footer className="body-font" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : '#30336b' }}>
            ...
            <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                    Blog-app
                    <a
                        href="https://x.com/baboria_nittish"
                ...
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    ...
                    {/* Icon 3  */}
                    <a href='https://www.instagram.com/nittish_baboria/' target='main' className="ml-3 text-gray-500">
                        <svg
                            fill="none"
                            stroke="currentColor"
                            strokeLinecap="round"
                    ...
                    {/* Icon 4  */}
                    <a href='https://www.linkedin.com/in/nittish-baboria-73b416298/' target='blank' className="ml-3 text-gray-500">
                        <svg
                            fill="currentColor"
                            stroke="currentColor"
                            strokeLinecap="round"
